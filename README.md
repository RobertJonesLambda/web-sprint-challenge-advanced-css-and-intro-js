...
Accessibility is embedding elements into sites to help people with various disabilities. As an example providing a text description of an image for blind people.  

2. Talk about 3 different things you can do to ensure your website is accessible. 
    1. Providing a text description of an image for blind people.  
    2. Not relying on color for navigation
    3. Providing transcripts for audio

3. How would you explain the concept of a variable to someone new to programming?
A variable is just a representation of some kind of data. 

4. What is the purpose of using functions in code?
A function is a set of instructions to produce some kind of output
